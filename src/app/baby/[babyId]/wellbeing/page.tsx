...
const getSubs = (t: any) => [
  {
    key: 'illness', label: t('baby.wellbeing.illness'), sub: t('baby.wellbeing.illnessSub'),
  ...
  {
    key: 'development', label: t('baby.wellbeing.development'), sub: t('baby.wellbeing.developmentSub'),
  ...
  {
    key: 'behavior', label: t('baby.wellbeing.behavior'), sub: t('baby.wellbeing.behaviorSub'),
...
export default function WellbeingPage() {
  ...
  return (
    <div className="page-bg flex flex-col min-h-screen">
      <Topbar title={t('baby.dashboard.wellbeing')} backLabel={t('common.back')} backHref={`/baby/${babyId}`} />
